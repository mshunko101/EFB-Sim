...
// EFB-Sim.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CEFBSimApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CEFBSimApp::OnAppAbout)
...
CEFBSimApp::CEFBSimApp() noexcept
{
	...
	SetAppID(_T("EFBSim.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CEFBSimApp
...
// {01bf4459-b9b1-42c0-a8c1-e39662bbcb85}
static const CLSID clsid =
{0x01bf4459,0xb9b1,0x42c0,{0xa8,0xc1,0xe3,0x96,0x62,0xbb,0xcb,0x85}};


// Инициализация CEFBSimApp

BOOL CEFBSimApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_EFBSimTYPE,
		RUNTIME_CLASS(CEFBSimDoc),
		RUNTIME_CLASS(CChildFrame), // настраиваемая дочерняя рамка MDI
		RUNTIME_CLASS(CEFBSimView));
	if (!pDocTemplate)
		return FALSE;
	pDocTemplate->SetContainerInfo(IDR_EFBSimTYPE_CNTR_IP);
	pDocTemplate->SetServerInfo(
		IDR_EFBSimTYPE_SRVR_EMB, IDR_EFBSimTYPE_SRVR_IP,
...
// Обработчики сообщений CEFBSimApp
